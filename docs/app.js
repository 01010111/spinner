...
zero_utilities_Vec2.arr_set = function(this1,n,v) {
	if(n < 0 || n > 1) {
		return;
	} else {
		this1[n] = v;
...
zero_utilities_Vec2.arr_get = function(this1,n) {
	return this1[Math.floor(Math.max(Math.min(n,1),0))];
};
...
zero_utilities_Vec2.scale = function(this1,n) {
	var x = this1[0] * n;
	var y = this1[1] * n;
	if(y == null) {
		y = 0;
...
zero_utilities_Vec2.equals = function(this1,v) {
	if(this1[0] == v[0]) {
		return this1[1] == v[1];
	} else {
		return false;
...
zero_utilities_Vec2.in_circle = function(this1,c,r) {
	var this2 = zero_utilities_Vec2.subtract(c,zero_utilities_Vec2.from_array_float(this1));
...
zero_utilities_Vec2.facing = function(this1,v) {
...
zero_utilities_Vec2.distance = function(this1,v) {
	var this2 = zero_utilities_Vec2.subtract(v,zero_utilities_Vec2.from_array_float(this1));
	return Math.sqrt(this2[0] * this2[0] + this2[1] * this2[1]);
};
...
zero_utilities_Vec2.add_f = function(v,n) {
	return zero_utilities_Vec2.get(v[0] + n,v[1] + n);
};
zero_utilities_Vec2.subtract = function(v1,v2) {
	return zero_utilities_Vec2.get(v1[0] - v2[0],v1[1] - v2[1]);
};
zero_utilities_Vec2.subtract_f = function(v,n) {
	return zero_utilities_Vec2.get(v[0] - n,v[1] - n);
};
zero_utilities_Vec2.multiply = function(v1,v2) {
	return zero_utilities_Vec2.get(v1[0] * v2[0],v1[1] * v2[1]);
};
zero_utilities_Vec2.multiply_f = function(v,n) {
	return zero_utilities_Vec2.get(v[0] * n,v[1] * n);
};
zero_utilities_Vec2.divide = function(v1,v2) {
	return zero_utilities_Vec2.get(v1[0] / v2[0],v1[1] / v2[1]);
};
zero_utilities_Vec2.divide_f = function(v,n) {
	return zero_utilities_Vec2.get(v[0] / n,v[1] / n);
};
zero_utilities_Vec2.mod = function(v1,v2) {
	return zero_utilities_Vec2.get(v1[0] % v2[0],v1[1] % v2[1]);
};
zero_utilities_Vec2.mod_f = function(v,n) {
	return zero_utilities_Vec2.get(v[0] % n,v[1] % n);
};
zero_utilities_Vec2.get_xx = function(this1) {
	return zero_utilities_Vec2.get(this1[0],this1[0]);
};
zero_utilities_Vec2.get_xy = function(this1) {
	return zero_utilities_Vec2.get(this1[0],this1[1]);
};
zero_utilities_Vec2.get_yx = function(this1) {
	return zero_utilities_Vec2.get(this1[1],this1[0]);
};
zero_utilities_Vec2.get_yy = function(this1) {
	return zero_utilities_Vec2.get(this1[1],this1[1]);
};
zero_utilities_Vec2.get_xxx = function(this1) {
	return zero_utilities_Vec3.get(this1[0],this1[0],this1[0]);
};
zero_utilities_Vec2.get_xxy = function(this1) {
	return zero_utilities_Vec3.get(this1[0],this1[0],this1[1]);
};
zero_utilities_Vec2.get_xyx = function(this1) {
	return zero_utilities_Vec3.get(this1[0],this1[1],this1[0]);
};
zero_utilities_Vec2.get_xyy = function(this1) {
	return zero_utilities_Vec3.get(this1[0],this1[1],this1[1]);
};
zero_utilities_Vec2.get_yxx = function(this1) {
	return zero_utilities_Vec3.get(this1[1],this1[0],this1[0]);
};
zero_utilities_Vec2.get_yxy = function(this1) {
	return zero_utilities_Vec3.get(this1[1],this1[0],this1[1]);
};
zero_utilities_Vec2.get_yyx = function(this1) {
	return zero_utilities_Vec3.get(this1[1],this1[1],this1[0]);
};
zero_utilities_Vec2.get_yyy = function(this1) {
	return zero_utilities_Vec3.get(this1[1],this1[1],this1[1]);
};
zero_utilities_Vec2.get_xxxx = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[0],this1[0],this1[0]);
};
zero_utilities_Vec2.get_xxxy = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[0],this1[0],this1[1]);
};
zero_utilities_Vec2.get_xxyx = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[0],this1[1],this1[0]);
};
zero_utilities_Vec2.get_xxyy = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[0],this1[1],this1[1]);
};
zero_utilities_Vec2.get_xyxx = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[1],this1[0],this1[0]);
};
zero_utilities_Vec2.get_xyxy = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[1],this1[0],this1[1]);
};
zero_utilities_Vec2.get_xyyx = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[1],this1[1],this1[0]);
};
zero_utilities_Vec2.get_xyyy = function(this1) {
	return zero_utilities_Vec4.get(this1[0],this1[1],this1[1],this1[1]);
};
zero_utilities_Vec2.get_yxxx = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[0],this1[0],this1[0]);
};
zero_utilities_Vec2.get_yxxy = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[0],this1[0],this1[1]);
};
zero_utilities_Vec2.get_yxyx = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[0],this1[1],this1[0]);
};
zero_utilities_Vec2.get_yxyy = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[0],this1[1],this1[1]);
};
zero_utilities_Vec2.get_yyxx = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[1],this1[0],this1[0]);
};
zero_utilities_Vec2.get_yyxy = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[1],this1[0],this1[1]);
};
zero_utilities_Vec2.get_yyyx = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[1],this1[1],this1[0]);
};
zero_utilities_Vec2.get_yyyy = function(this1) {
	return zero_utilities_Vec4.get(this1[1],this1[1],this1[1],this1[1]);
};
...
zero_utilities_Vec3.get = function(x,y,z) {
	...
	if(zero_utilities_Vec3.pool != null && zero_utilities_Vec3.pool.length > 0) {
		var this1 = zero_utilities_Vec3.pool.shift();
		var x1 = x;
		var y1 = y;
		var z1 = z;
		if(z == null) {
...
Main.animate_time_max = 0.75;
Main.scale = 1;
Main.progress = 0;
Main.complete = false;
Main.begun = false;
Main.values = ["Etienne Naylor","Zachary Edmonds","Anwen Mccormack","Bronte Parker","Morgan Bauer","Christopher Mcneil","Adam Leon","Anoushka Hartley","Shoaib Oliver","Ruby Lambert","Rahima Chaney","Dua Walters","Kiaan Lutz","Rosemary Coffey","Ifan Bob","Anya Hickman","Sulayman Beil","Kaidan Read","Madihah Lucas","Abdur Brady","Kaylee Leech","Layton Nicholson","Harper-Rose Weir","Alyssa Downs","Torin Bloom","Jorgie Plant","Latisha Moon","Izaac Glover","Dora Piper","Aaliya Kirkland","Lorcan Bains","Nabila Bannister","Zahrah Sparks","Faizan Shea","Keyan Weiss","Heena Chester","Jordanna Montoya","Aleena Decker","Maryam King","Maximus Wiley","Kyle Croft","Brandi Simons","Caitlin Wardle","Hassan Greenwood","Greyson Henry","Ariah Butt","Sadie Marks","Simeon Molina","Margaret North","Cory Rodriguez","Eadie Almond","Sohail Hobbs","Jonty Baxter","Dawson Anderson","Jessie Whitfield","Katerina Cardenas","Sonnie Kavanagh","Shanai Tyson","Ariya Greer","Kane Horton","Andy Cousins","Arooj Henson","Aneesa Doherty","Steven Mayer","Charlotte Morin","Cathy Webster","Miyah Simmonds","Alessandro Lowry","Siddharth Alvarado","Ritchie Ellwood","Lyle Barajas","Johnny Mill","Viola Baird","Aubree Liu","Ananya Galloway","Marion Freeman","Kareena Mathis","Aamna Stokes","Kayleigh Cullen","Ellis Combs","Yuvaan Finley","Harold Walton","Alexis Boyer","Adelaide Kerr","Nicolle Ferguson","Tariq Poole","Eleanor Lozano","Raj Morley","Kianna Mccullough","Carley O'Neill","Arham Osborne","Brooklyn Cabrera","Freya Clarkson","Anand Shah","Jamie-Lee Rayner","Aimie Moore","Zander Villalobos","Aleyna William","Emilia Riley","Aqib Rankin"];
